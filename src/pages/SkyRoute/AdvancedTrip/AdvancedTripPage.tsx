		...
		<main className="sr-page">
			<section className="mb-6">
				...
				<p className="mt-2 text-sm text-body">
					Ejecuta el viaje paso a paso: inicia, solicita recomendaciones y avanza
					seleccionando aeronaves y destinos.
				</p>
			</section>
			...
			<section className="sr-two-columns">
				<Card className="sr-panel">
					<div className="sr-panel__header">
						<div>
							<h2>Iniciar viaje</h2>
							<p>Define origen, presupuesto inicial y tiempo total disponible.</p>
						</div>
					...
					<div className="sr-form-grid">
						...
						<Input
							...
							onChange={(e) => setPresupuestoInput(Number(e.target.value))}
						/>
						...
						<Input
							...
							onChange={(e) => setTiempoInput(Number(e.target.value))}
						/>

						<Button
							onClick={() => startTrip(originInput, presupuestoInput, tiempoInput)}
							loading={loading}
						>
							Iniciar viaje
						</Button>
			...
			<section className="mt-6">
				<StepActionsPanel
					...
					onRecommend={(criterio) => getRecommendation(criterio)}
					onAdvance={(destino, aeronave) => advanceTo(destino, aeronave)}
